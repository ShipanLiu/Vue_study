...
<template>
  <nav class="bg-white border-gray-200 dark:bg-gray-900 w-full">
    <div class="w-full flex flex-wrap items-center justify-between flex-row ml-0 p-4">
      <a href="/#" class="flex items-center">
        <img src="@/assets/svg/logo2.svg" class="h-8 mr-3" alt="Flowbite Logo" />
        <span class="text-[#d81e06] self-center text-2xl font-semibold whitespace-nowrap dark:text-white">D-Render</span>
      </a>
